...
def get_patron_status_report(patron_id: str) -> tuple[
     bool, str, dict[str, list[tuple[str, Any, str, Any]] | list[tuple[str, Any, str, Any, str, Any, str]] | int]]:
    """
...
def pay_late_fees(patron_id: str, book_id: int, payment_gateway: PaymentGateway = None) -> Tuple[
    ...
    # Because the late fee function returns a tuple, I can simply retrieve the fee amount directly
    success, message, fee_info = calculate_late_fee_for_book(patron_id, book_id)
