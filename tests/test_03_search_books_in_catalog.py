...
def test_search_book_ISBN(library_setup):
...
def test_search_book_full_title(library_setup):
...
def test_search_book_partial_title(library_setup):
...
def test_search_book_title_all_caps(library_setup):
...
def test_search_book_title_lowercase_partial(library_setup):
    # Positive test case to test case insensitivity for the assignment.
...
def test_search_book_author(library_setup):
...
def test_search_book_author_uppercase(library_setup):
    # A positive test case that searches the author of the book
...
def test_search_book_author_lowercase(library_setup):
...
def test_search_book_author_partial(library_setup):
...
def test_invalid_search_type(library_setup):
    # Invalid search type.
...
def test_invalid_search_type_nothing(library_setup):
...
def test_no_books_ISBN(library_setup):
...
def test_no_books_author(library_setup):
...
def test_no_books_title(library_setup):
